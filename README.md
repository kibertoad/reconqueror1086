...
| Tournaments and quests | Wagered jousts and skirmishes (`parity/TOURNEY.md` lists how far they follow the original), courtship ladders, marriage, imported conversations (`parity/TALK.md`), the dragon equipment quest, and crown/dragon/age endings. |
