...
| Combat parity | Foreground input targeting, crossbow lifetime, blood cadence, critical-hit behavior, sub-cell movement, enemy/retainer AI, stair transitions, enemy food use, pickup rewards, loot, siege consequences, and some presentation sequencing remain provisional. Melee foreground trajectories and door state targets now follow the executable-confirmed paths. |
