...
| Combat parity | Foreground trajectory, critical-hit behavior, sub-cell movement, enemy/retainer AI, stair transitions, enemy food use, pickup rewards, loot, siege consequences, and some presentation sequencing remain provisional. Door actions now follow their executable-confirmed immediate state targets. |
