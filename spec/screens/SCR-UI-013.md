...
superseded_by: []
resolution: 640x480
evidence: [FND-TALK-007, FND-UI-001, FND-UI-002, FND-UI-003, FND-UI-009, FND-UI-010, FND-UI-011]
conflicting: []
split_with: []
...
| Conversation picture | `C1086.GOB#comscrn1.pcx`, picture `0x12E` | None | (0, 0, 640, 480) | While a conversation runs | FND-UI-009, FND-UI-011 |
