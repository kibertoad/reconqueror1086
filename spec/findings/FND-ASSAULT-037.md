---
id: FND-ASSAULT-037
title: Placed pickups use interaction selectors 5, 7, 9 and 10 with fixed arguments
status: recorded
builds: [BLD-GOG-EN]
superseded_by: []
...
| Selector | First argument | Second argument | Placements |
|---:|---:|---:|---:|
| 5 | 25 | | 36 |
| 7 | 2 | 6 | 70 |
| 9 | 6 | | 36 |
...
The blocks' labels name coins for selector 5, food for 7, an armour item for 9 and crossbow
bolts for 10.

## Interpretation

Coins give 25 wealth, food heals 2d6, the armour pickup sets equipment bit 6, and bolts give 12
ammunition.
...
Decode each archive's `Blocks` and group the placed kind-4 blocks with behaviour bit `0x10` by
their word `+0x48`.
