...
builds: [BLD-GOG-EN]
superseded_by: []
evidence: [FND-TOURNEY-001, FND-TOURNEY-002, FND-TOURNEY-003, FND-TOURNEY-004, FND-RNG-002, FND-TALK-006, FND-TALK-007, FND-UI-004]
conflicting: []
split_with: []
...
three tournament dwords to -1, the three counts and `opponents_ready` to 0 and `tournament_here` to 1.
