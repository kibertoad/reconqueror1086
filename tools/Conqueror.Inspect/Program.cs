...
var sceneBlockReport = new StringBuilder("# Archive  Index  Placed  Kind  Behavior  Flags  ColorMap  Field40  Field48  Field4A  Size  Surfaces  Name\n");
                ...
                || sceneName.StartsWith("DEFEND", StringComparison.OrdinalIgnoreCase)))
            {
                ...
                foreach (var block in scene.Blocks)
                {
                    ...
                    sceneBlockReport.AppendLine($"{file.Path}  {block.Index,5}  {placements[block.Index],6}  "
                        ...
                        + $"{BinaryPrimitives.ReadInt16LittleEndian(record.Slice(0x48, 2)),7}  {BinaryPrimitives.ReadInt16LittleEndian(record.Slice(0x4A, 2)),7}  "
