...
internal static class SceneBlockReport
{
    internal static StringBuilder Create() => new(
        "# Archive  Index  Placed  Kind  Behavior  Flags  ColorMap  Field10  Field14  Width  Field1C  Height  OffsetX8  OffsetY8  Field40  StateEffect  MoveEffect  MoveFrames  MoveMs  MoveFlags  MoveDX  MoveDY  MoveBlockDX  MoveLoopBlock  MoveSurfaceDX  MoveEndSurface  MoveHeadingDX  Field48  Field4A  Field4C  Surfaces  Name\n");
        ...
        byte[] blockBytes, IReadOnlyList<DynamixSceneEffectDefinition> effects, int placements)
    {
        ...
        report.AppendLine($"{archive}  {block.Index,5}  {placements,6}  "
            ...
            + $"{block.TextureWidth,7}  {block.TextureWidthShift,7}  {block.TextureHeight,5}  "
            + $"{block.LowerElevation,7}  {block.UpperElevation,6}  "
            ...
            + $"{block.Surface0},{block.Surface1},{block.Surface2},{block.Surface3}  "
