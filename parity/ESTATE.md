...
| `RULE-ESTATE-003` | Loans and the July collection | supported | partial | None | `DEV-ESTATE-001` | supported | The debt of the loan plus half and the July demand match; a won fight clears the debt on both branches and refuses later loans, and loans below 20 are accepted. |
