...
| `RULE-SAVE-003` | Reading a saved game | supported | partial | None | None | supported | A damaged slot falls back to its backup; the original stops the program. There is no version string. |
