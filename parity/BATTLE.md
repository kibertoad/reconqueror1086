...
| `RULE-BATTLE-001` | Field battle resolution | supported | partial | None | None | supported | The automatic battle adds a third of each morale value where the original adds the remainder by 3 (BUG-BATTLE-001). The choice screen, display mode and survey are host code. |
