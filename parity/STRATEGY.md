...
| `RULE-STRATEGY-018` | Spies | supported | partial | None | None | supported | The spy is part of the dated campaign model and reports the first active force only; the rule reports every live force and needs a hostile force before it returns. |
