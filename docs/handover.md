...
4. Continue exact route/spy recovery, estate tile mapping, and remaining sound/event bindings as ordered in the migration plan. `JUMP!!` is closed by the callback-registration evidence described below.
