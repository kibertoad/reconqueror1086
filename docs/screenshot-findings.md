...
- Recover exact War Planning controls and the `JUMP!!` effect, then recover behavior/cost semantics for currently display-only management rows and replace the provisional terrain fill with editable tiles.
