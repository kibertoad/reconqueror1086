...
- **Partially implemented:** New Game, Load, Save, Resume, Exit, Credits, and Movie have real state transitions. Credits plays `CREDITZZ.SMK`; Movie replays `TITLE.SMK`. Practice remains unavailable pending its runtime system.
