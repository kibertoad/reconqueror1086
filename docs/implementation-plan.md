...
- [x] Activate screenshot-confirmed `INNPEOPL.PCX` and bind its ten patron regions plus footer through `VINN.HAT`, while keeping unproven identities and dialogue explicitly unavailable.
