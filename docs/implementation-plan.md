...
| M7: Release | 10 | In progress: launch/test/import batch utilities, five atomic save slots with explicit schema migration and previous-generation recovery, a data-driven legal-boundary check, and Windows CI are implemented. | Autosave, richer corruption diagnostics, importer repair workflow, packaging, and clean-machine verification. |
