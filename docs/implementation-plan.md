...
| M7: Release | 10 | In progress: launch/test/import batch utilities, five atomic save slots with explicit schema migration and previous-generation recovery, manifest-wide importer verify/repair commands, a data-driven legal-boundary check, and Windows CI are implemented. | Incremental/resumable import, clean uninstall, autosave, richer corruption diagnostics, packaging, and clean-machine verification. |
