...
1. Continue first-person combat recovery: confirm London/base-scene selection, foreground frame cadence, weapon-category dispatch, and blood-effect triggers; then recover non-door block transitions and replace the remaining provisional combat, AI, retainer, loot, and consequence rules.
