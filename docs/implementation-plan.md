...
| M7: Release | 10 | In progress: launch/test/import batch utilities, five atomic save slots with explicit schema migration and previous-generation recovery, atomic content-aware import writes, manifest-wide verify/repair and manifest-scoped uninstall commands, a data-driven legal-boundary check, and Windows CI are implemented. | Progress reporting and resumable interrupted imports, autosave, richer corruption diagnostics, packaging, and clean-machine verification. |
