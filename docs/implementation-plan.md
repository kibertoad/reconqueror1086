...
1. Continue first-person combat recovery: recover processor-independent presentation of the original four render-counted blood steps; then locate pickup reward mutations and replace the provisional combat, AI, retainer, loot, and consequence rules.
