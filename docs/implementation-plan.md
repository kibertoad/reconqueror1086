...
1. Continue first-person combat recovery: confirm London/base-scene selection and foreground state cadence; then recover non-door block transitions and replace the remaining provisional combat, AI, retainer, loot, and consequence rules.
