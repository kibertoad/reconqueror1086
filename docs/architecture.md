...
| `OriginalStrategicMovement` | executable record layout, generation gate, and lord/household force initializer; deliberately excludes the not-yet-modeled original route and lord records | strategic movement recovery boundary |
